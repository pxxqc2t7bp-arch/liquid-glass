...
- `DESIGN-prismatic-liquid-glass.md`：更大胆的 Prismatic Liquid Glass 分支，强调内容层鲜明配色、环境色折射和单一 Apple Action Blue 交互色。
...
- 更大胆的内容层配色：产品图、图表、地图、媒体和创作画布可以更鲜明，但不替代主交互色
- Liquid Glass 的真实 `backdrop-filter`、透明玻璃、边缘高光、环境色折射
- 清晰的材质层级：薄玻璃导航、中等玻璃面板、厚玻璃弹窗
- 可用的第一屏产品 UI，而不是概念海报或说明页
- 高可读性、移动端性能和无障碍约束

## 使用方法

1. 如果想要更克制、标准的 Apple Liquid Glass 方向，打开 `DESIGN-liquid-glass.md`
2. 如果想要更鲜明、更有折射色彩的方向，打开 `DESIGN-prismatic-liquid-glass.md`
3. 阅读顶部的设计目标和硬性要求
4. 将文档末尾的 Stitch Prompt 粘贴到 Stitch
5. 根据你的产品类型补充具体页面需求，例如 dashboard、媒体播放器、地图、日历、购物页或设计工具
...
- 第一屏必须是可用 UI，不要做介绍页
- 多使用 Liquid Glass：导航、浮动条、悬浮面板、搜索、tab、弹窗、toast
- 背景必须有真实内容支撑玻璃效果
- 只使用 Apple Action Blue 作为主交互色
- 可以使用更大胆的背景/内容色，但强色要来自真实内容，并通过玻璃材质柔化
...
- [DESIGN-prismatic-liquid-glass.md](./DESIGN-prismatic-liquid-glass.md)
